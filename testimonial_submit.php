    ...
    <section class="section-padding bg-dark inner-header" style="background-image: url('assets/images/banner-image/4.jpg');height: 250px;" >
	  ...
	  <div class="page-content bg-white">
        ...
        <div class="content-block">
            <br/>
            <h2 style="text-align:center">Submit Testimonial </h2>	
            <br/>
            <br/><!-- Browse Jobs -->
...
<tr>
 ...
 <tr>
 <form method=POST>
  <td><b>Please type your Views / Experience / Suggestions about NetMoney in below testimonial box and we will display it above with your photo on Testimonial page: </b><br><br>
  <textarea class="form-control" name=testimonial rows=15></textarea><br>
  <span class=note><i class="fa fa-info-circle" aria-hidden="true"></i> Please provide testimonial in minimum 100 characters long. Please do not exceed 2000 characters.</span>
  <br><br>
  <button class="site-btn" name="submitTestimonial" value="submitTestimonial" type="submit">Submit Testimonial</button>
 </form> 
 </tr>
