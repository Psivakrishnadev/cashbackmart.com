...
<head>
    ...
    <!-- <link rel="stylesheet" href="{{ asset('frontEnd/assets') }}/css/plugins/bootstrap.min.css" />
        ...
        <link rel="stylesheet" href="{{ asset('frontEnd/assets') }}/css/plugins/ionicons.min.css" /> -->
    <!--===== Plugins CSS (All Plugins Files) =====-->
    <!-- <link rel="stylesheet" href="{{ asset('frontEnd/assets') }}/css/plugins/jquery-ui.min.css" />
        <link rel="stylesheet" href="{{ asset('frontEnd/assets') }}/css/plugins/meanmenu.css" />
...
<body class="home-12 home-20 home-medical" style="background: #8ff5b3;">
                ...
                <div class="row">
                    <div class="col-lg-6 mb-res-sm-50px">
                        <div class="about-left-image">
                            <img src="{{ asset('frontEnd/assets') }}/images/feature-bg/1.jpg" alt=""
                    ...
                    <div class="col-lg-6">
                        <div class="about-content">
                            <div class="sc-pbKro bjcxym">
                                ...
                                <div class="text-danger bg-orange">{{$error}}</div>
                                @endforeach
                                @endif
                                    ...
                                    <div class="sc-pBAKv bbJvDc">
                                        ...
                                        <div class="sc-psAte eFyYvN">
                                            ...
                                            <div class="sc-fznWOq izezvj wrapper">
                                                ...
                                                <input placeholder=" Enter Your Mobile Number" name="phoneno"
    ...
    <!-- <script src="{{ asset('frontEnd/assets') }}/js/plugins/bootstrap.min.js"></script>
        ...
        <script src="{{ asset('frontEnd/assets') }}/js/plugins/meanmenu.js"></script>
        ...
        <script src="{{ asset('frontEnd/assets') }}/js/plugins/range-script.js"></script> -->
