                                ...
                                <div class="main-navigation d-none d-lg-block">
                                    <ul>
                                        ...
                                        <li class="menu-dropdown">
                                            ...
                                            <li class="menu-dropdown">
                                                <a href="bp.html">Business Plan <i class="ion-ios-arrow-down-a"></i></a>
                                            </li>
                                            <li class="menu-dropdown">
                                                <a href="#">Referral Income <i class="ion-ios-arrow-down-a"></i></a>
                                            </li>
                                            <li class="menu-dropdown">
                                                <a href="#">Register <i class="ion-ios-arrow-down"></i></a>
                                                <ul class="sub-menu">
    ...
    <section class="section-padding bg-dark inner-header" style="background-image: url('assets/images/banner-image/4.jpg');height: 250px;" >
	  ...
	  <div class="page-content bg-white">
        ...
        <div class="content-block">
            <br/>
            <h2 style="text-align:center">Support Tickets</h2>	
            <br/>
            <br/><!-- Browse Jobs -->
...
<tr>
 ...
 <tr>
  <td>
    ...
    <td align=right><a onClick="document.getElementById('divNewTicket').style.display='block';" class="site-btn">CREATE NEW TICKET</a>
    </tr></table>
 </tr>
 
    
    
        <tr><td><p><p><span style="font-size:18px"><span style="font-family:Trebuchet MS,Helvetica,sans-serif"><strong><span style="color:#0000ff">Here you can send your query directly to the company support executive and our executive will reply you within 24-48 hrs.</span></strong></span></span></p><p></tr>
     
 
 <tr>
    <form method=POST enctype="multipart/form-data">
    <td align=center>
    <div id="divNewTicket" style="display:none;">
    <table cellspacing=0 cellpadding=10 align=center>
    <tr>
        <td colspan=2><h2>Create New Ticket</h2></td>
    </tr>    
    
    <tr>
        <td colspan=2>
        Please provide subject of your query:<br>
        <input class="form-control" type=text required name=subject placeholder="Subject should be within 10 to 100 characters">
        </td>
    </tr>
    
    <tr>
        <td colspan=2>
        Please provide your detailed query in the box given below:<br>
        <textarea class="form-control" name=message required rows=5 placeholder="Your query/message should be at least 50 characters long"></textarea>
        </td>
    </tr>
    
    <tr>
        <td colspan=2>
        Select image if you want to attach with your ticket:<br>
        <input class="form-control" type=file name=image style='color:#000000;'>
        </td>
    </tr>
    ...
    <tr valign=bottom>
        <td colspan=2>
        <table><tr>  
        <td><span class='note'>Please enter displayed 4 digit code in this text box.</span>
        <td><input class="form-control" required name="captcha" size=10 type="text" placeholder="Enter Code"> 
        <td><img src="captcha.php" />
        </tr></table>
    </tr>
    
    <tr valign=top>
    <td align=right><button name="submitNewTicket" class="site-btn" value="submitNewTicket" type="submit">Submit New Ticket</button>
    <td><a onClick="document.getElementById('divNewTicket').style.display='none';" class="genric-btn primary circle arrow">CANCEL</a>
    </tr>    
    </table>    
    </div>    
    </td> 
...
<tr>
    ...
    <tr>
        <td class=heading>Ticket ID</td>
        <td class=heading width=40%>Subject</td>
        ...
        <tr valign=top>
         <td style='border-bottom:1px solid #999999;background-color:#FFDDDD'>1592337702 <br><font color=red>Replied</font>
         <td style='border-bottom:1px solid #999999;'>Regarding activation P Venkatesham Gupta  Account ID: 1435337
         <td style='border-bottom:1px solid #999999;'>17th Jun 2020 10:22AM
         <td style='border-bottom:1px solid #999999;'><font color=red>CLOSED</font>
         <td style='border-bottom:1px solid #999999;'><a href='ticket_view.php?ticketId=1592337702' class='button'>View Ticket</a>
        </tr>
            
    <tr>
        <td colspan=5 align=center><div class='row'><div class='col-lg-12'><a href='#' class='pagi-btn'>1</a> </div></div>    </tr>
    </table>    
