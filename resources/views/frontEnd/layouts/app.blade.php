 ...
 <head>
     ...
     <title>CachbackMart | {{$pageTitle}}</title>
                                         ...
                                         <div class="mini-cart-content">
                                             <ul>
                                                 <li class="single-shopping-cart">
                                                     <div class="shopping-cart-img">
                                                         <a href="single-product.html"><img alt=""
                                                                 src="{{ asset('frontEnd/assets') }}/images/product-image/mini-cart/1.jpg" /></a>
                                                 ...
                                                 <li class="single-shopping-cart">
                                                     <div class="shopping-cart-img">
                                                         <a href="single-product.html"><img alt=""
                                                                 src="{{ asset('frontEnd/assets') }}/images/product-image/mini-cart/2.jpg" /></a>
                                                         <span class="product-quantity">1x</span>
                                                     </div>
                                                     <div class="shopping-cart-title">
         ...
         <div class="slider-area">
             <div class="slider-active-3 owl-carousel slider-hm8 owl-dot-style">
                 ...
                 <div class="slider-height-10 d-flex align-items-start justify-content-start bg-img"
                     style="background-image: url({{ asset('frontEnd/') }}/img/sample-32.jpg);">
                     <div class="container">
                 ...
                 <!-- Slider Single Item Start -->
                 <div class="slider-height-10 d-flex align-items-start justify-content-start bg-img"
                     style="background-image: url({{ asset('frontEnd/') }}/img/sample-33.jpg);">
                     <div class="container">
                         <div class="slider-content-16 slider-animated-1 text-left">
                             <h1 class="animated">
                                 DISPOSABLE<br />
                 ...
                 <!-- Slider Single Item Start -->
                 <div class="slider-height-10 d-flex align-items-start justify-content-start bg-img"
                     style="background-image: url({{ asset('frontEnd/') }}/img/Slider.jpg);">
                     <div class="container">
                         <div class="slider-content-16 slider-animated-1 text-left">
                             <!-- <h1 class="animated">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-res-xs-30 mb-res-sm-30">
                                <div class="banner-wrapper">
                                    <a href="shop-4-column.html"><img src="{{ asset('frontEnd/assets') }}/images/banner-image/48.jpg" alt="" /></a>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="banner-wrapper">
                                    <a href="shop-4-column.html"><img src="{{ asset('frontEnd/assets') }}/images/banner-image/49.jpg" alt="" /></a>
                                </div>
                            </div>
                        </div>
                    </div>
                         ...
                         <div class="new-product-slider-2 owl-carousel owl-nav-style owl-nav-style-5">
                                 ...
                                 <article class="list-product mb-30px">
                                     <div class="img-block">
                                         <a href="single-product.html" class="thumbnail">
                                             <img class="first-img"
                                                 src="{{ asset('frontEnd/assets') }}/images/BOTTLES JET.jpg" alt="" />
                             ...
                             <div class="product-inner-item">
                                 <article class="list-product mb-30px">
                                     <div class="img-block">
                                         <a href="single-product.html" class="thumbnail">
                                             <img class="first-img"
                                                 src="{{ asset('frontEnd/assets') }}/images/AUTOMATIC HAND SANITIZER.jpg"
                                                 alt="" />
                                             <img class="second-img"
                                                 src="{{ asset('frontEnd/assets') }}/images/AUTOMATIC HAND SANITIZER.jpg"
                                                 alt="" />
                             ...
                             <div class="product-inner-item">
                                 <article class="list-product mb-30px">
                                     <div class="img-block">
                                         <a href="single-product.html" class="thumbnail">
                                             <img class="first-img"
                                                 src="{{ asset('frontEnd/assets') }}/images/chlorhexidine-gluconate-mouthwash.jpg"
                                                 alt="" />
                                             <img class="second-img"
                                                 src="{{ asset('frontEnd/assets') }}/images/chlorhexidine-gluconate-mouthwash.jpg"
                                                 alt="" />
                             ...
                             <div class="product-inner-item">
                                 <article class="list-product mb-30px">
                                     <div class="img-block">
                                         <a href="single-product.html" class="thumbnail">
                                             <img class="first-img" src="{{ asset('frontEnd/assets') }}/images/MIX.jpg"
                                                 alt="" />
                                             <img class="second-img" src="{{ asset('frontEnd/assets') }}/images/MIX.jpg"
                                                 alt="" />
                                         </a>
                                         <div class="quick-view">
                                             <a class="quick_view" href="wishlist.html" title="Add to wishlist">
                             ...
                             <div class="product-inner-item">
                                 <article class="list-product mb-30px">
                                     <div class="img-block">
                                         <a href="single-product.html" class="thumbnail">
                                             <img class="first-img"
                                                 src="{{ asset('frontEnd/assets') }}/images/Face Shield.jpg" alt="" />
                                             <img class="second-img"
                                                 src="{{ asset('frontEnd/assets') }}/images/Face Shield.jpg" alt="" />
                                         </a>
                                         <div class="quick-view">
                         ...
                         <div class="new-product-slider-2 owl-carousel owl-nav-style owl-nav-style-5">
                             ...
                             <div class="product-inner-item">
                                 <article class="list-product mb-30px">
                                     <div class="img-block">
                                         <a href="single-product.html" class="thumbnail">
                                             <img class="first-img"
                                                 src="{{ asset('frontEnd/assets') }}/images/1 vasavi electro wheelz Model (1).jpg"
                                                 alt="" />
                                             <img class="second-img"
                                                 src="{{ asset('frontEnd/assets') }}/images/1 vasavi electro wheelz Model (1).jpg"
                                                 alt="" />
                             ...
                             <div class="product-inner-item">
                                 <article class="list-product mb-30px">
                                     <div class="img-block">
                                         <a href="single-product.html" class="thumbnail">
                                             <img class="first-img" src="{{ asset('frontEnd/assets') }}/images/V-60.jpg"
                                                 alt="" />
                                             <img class="second-img"
                                                 src="{{ asset('frontEnd/assets') }}/images/V-60.jpg" alt="" />
                                         </a>
                                         <div class="quick-view">
                                             <a class="quick_view" href="wishlist.html" title="Add to wishlist">
                                                 <i class="ion-android-favorite-outline"></i>
                             ...
                             <div class="product-inner-item">
                                 <article class="list-product mb-30px">
                                     <div class="img-block">
                                         <a href="single-product.html" class="thumbnail">
                                             <img class="first-img"
                                                 src="{{ asset('frontEnd/assets') }}/images/Vasavi Wheels (2).jpg"
                                                 alt="" />
                                             <img class="second-img"
                                                 src="{{ asset('frontEnd/assets') }}/images/Vasavi Wheels (2).jpg"
                                                 alt="" />
                             ...
                             <div class="product-inner-item">
                                 <article class="list-product mb-30px">
                                     <div class="img-block">
                                         <a href="single-product.html" class="thumbnail">
                                             <img class="first-img"
                                                 src="{{ asset('frontEnd/assets') }}/images/Vasavi Wheels (4).jpg"
                                                 alt="" />
                                             <img class="second-img"
                                                 src="{{ asset('frontEnd/assets') }}/images/Vasavi Wheels (4).jpg"
                                                 alt="" />
                             ...
                             <div class="product-inner-item">
                                 <article class="list-product mb-30px">
                                     <div class="img-block">
                                         <a href="single-product.html" class="thumbnail">
                                             <img class="first-img"
                                                 src="{{ asset('frontEnd/assets') }}/images/Vasavi Wheels (5).jpg"
                                                 alt="" />
                                             <img class="second-img"
                                                 src="{{ asset('frontEnd/assets') }}/images/Vasavi Wheels (5).jpg"
                                                 alt="" />
                             ...
                             <div class="product-inner-item">
                                 <article class="list-product mb-30px">
                                     <div class="img-block">
                                         <a href="single-product.html" class="thumbnail">
                                             <img class="first-img"
                                                 src="{{ asset('frontEnd/assets') }}/images/Vasavi Wheels E-Cycle (1).jpg"
                                                 alt="" />
                                             <img class="second-img"
                                                 src="{{ asset('frontEnd/assets') }}/images/Vasavi Wheels E-Cycle (1).jpg"
                                                 alt="" />
                             ...
                             <div class="product-inner-item">
                                 <article class="list-product mb-30px">
                                     <div class="img-block">
                                         <a href="single-product.html" class="thumbnail">
                                             <img class="first-img"
                                                 src="{{ asset('frontEnd/assets') }}/images/Vasavi Wheels.jpg" alt="" />
                                             <img class="second-img"
                                                 src="{{ asset('frontEnd/assets') }}/images/Vasavi Wheels.jpg" alt="" />
                                         </a>
                                         <div class="quick-view">
                    ...
                    <div class="container">
                        <div class="brand-slider owl-carousel owl-nav-style owl-nav-style-2">
                            <div class="brand-slider-item">
                                <a href="#"><img src="{{ asset('frontEnd/assets') }}/images/brand-logo/1.jpg" alt="" /></a>
                            </div>
                            <div class="brand-slider-item">
                                <a href="#"><img src="{{ asset('frontEnd/assets') }}/images/brand-logo/2.jpg" alt="" /></a>
                            </div>
                            <div class="brand-slider-item">
                                <a href="#"><img src="{{ asset('frontEnd/assets') }}/images/brand-logo/3.jpg" alt="" /></a>
                            </div>
                            <div class="brand-slider-item">
                                <a href="#"><img src="{{ asset('frontEnd/assets') }}/images/brand-logo/4.jpg" alt="" /></a>
                            </div>
                            <div class="brand-slider-item">
                                <a href="#"><img src="{{ asset('frontEnd/assets') }}/images/brand-logo/5.jpg" alt="" /></a>
                            </div>
                            <div class="brand-slider-item">
                                <a href="#"><img src="{{ asset('frontEnd/assets') }}/images/brand-logo/1.jpg" alt="" /></a>
                            </div>
                     ...
                     <div class="row">
                         ...
                         <div class="col-md-6 col-lg-4 mt-res-md-50px mt-res-sx-30px mt-res-md-30px">
                             <div class="single-wedge">
                                 ...
                                 <div class="img_app">
                                     <a href="#"><img src="{{ asset('frontEnd/assets') }}/images/icons/app_store-2.png"
                                             alt="" /></a>
                                     <a href="#"><img
                                             src="{{ asset('frontEnd/assets') }}/images/icons/google_play-2.png"
                                             alt="" /></a>
                                 </div>
                             </div>
                         </div>
                         ...
                         <div class="col-md-5 col-sm-12 col-xs-12">
                             <div class="tab-content quickview-big-img">
                                 <div id="pro-1" class="tab-pane fade show active">
                                     <img src="{{ asset('frontEnd/assets') }}/images/product-image/medical/1.jpg"
                                         alt="" />
                                 </div>
                                 <div id="pro-2" class="tab-pane fade">
                                     <img src="{{ asset('frontEnd/assets') }}/images/product-image/medical/2.jpg"
                                         alt="" />
                                 </div>
                                 <div id="pro-3" class="tab-pane fade">
                                     <img src="{{ asset('frontEnd/assets') }}/images/product-image/medical/3.jpg"
                                         alt="" />
                                 </div>
                                 <div id="pro-4" class="tab-pane fade">
                                     <img src="{{ asset('frontEnd/assets') }}/images/product-image/medical/4.jpg"
                                         alt="" />
                                 </div>
                             </div>
                             ...
                             <div class="quickview-wrap mt-15">
                                 <div class="quickview-slide-active owl-carousel nav owl-nav-style owl-nav-style-2"
                                     ...
                                     <a class="active" data-toggle="tab" href="#pro-1"><img
                                             src="{{ asset('frontEnd/assets') }}/images/product-image/medical/1.jpg"
                                             alt="" /></a>
                                     <a data-toggle="tab" href="#pro-2"><img
                                             src="{{ asset('frontEnd/assets') }}/images/product-image/medical/2.jpg"
                                             alt="" /></a>
                                     <a data-toggle="tab" href="#pro-3"><img
                                             src="{{ asset('frontEnd/assets') }}/images/product-image/medical/3.jpg"
                                             alt="" /></a>
                                     <a data-toggle="tab" href="#pro-4"><img
                                             src="{{ asset('frontEnd/assets') }}/images/product-image/medical/4.jpg"
                                             alt="" /></a>
                                 </div>
                             </div>
                         </div>
